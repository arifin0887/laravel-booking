...
<style>
    ...
    /* Style Modal Edit (Sama seperti modal Add) */
    .modal-content-custom { background-color: #fdfaf5; border: none; border-radius: 1rem; box-shadow: 0 20px 50px rgba(0,0,0,0.2); }
    .modal-header-custom { background-color: #e6d3b3; padding: 1rem 1.5rem; border-bottom: none; }
    .modal-header-custom .modal-title { color: var(--brand-text); font-weight: 700; font-family: 'Playfair Display', serif; }
                ...
                <div class="col-md-6">
                    <div class="detail-item">
                        ...
                        <div class="detail-item-content">
                            ...
                            <span class="value">{{ $room->capacity }} Persons</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="detail-item">
                        ...
                        <div class="detail-item-content">
                            ...
                            <span class="value">{{ ucfirst($room->status) }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content modal-content-custom">
            ...
            <form action="{{ route('rooms.update', $room->id) }}" method="POST">
                ...
                <div class="modal-body modal-body-custom">
                    <div class="mb-3">
                        <label for="name_room_edit" class="form-label-custom">Room Name</label>
                        <input type="text" name="name_room" id="name_room_edit" class="form-control form-control-custom" value="{{ $room->name_room }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="price_edit" class="form-label-custom">Price (Rp)</label>
                        <input type="number" name="price" id="price_edit" class="form-control form-control-custom" value="{{ $room->price }}" min="0" required>
                    </div>
                    <div class="mb-3">
                        <label for="capacity_edit" class="form-label-custom">Capacity</label>
                        <input type="number" name="capacity" id="capacity_edit" class="form-control form-control-custom" value="{{ $room->capacity }}" min="1" required>
                    </div>
                    <div class="mb-3">
                        <label for="description_edit" class="form-label-custom">Description</label>
                        <textarea name="description" id="description_edit" class="form-control form-control-custom" rows="3">{{ $room->description }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="status_edit" class="form-label-custom">Status</label>
                        <select name="status" id="status_edit" class="form-select form-select-custom" required>
