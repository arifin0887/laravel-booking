...
<head>
    ...
    <style>
        :root {
            --brand-primary: #8a6d4c;
            --brand-primary-dark: #5d4037;
            --brand-accent: #c5a47e;
            --brand-text: #3e2723;
            --bg-light: #f8f6f3;
            --bg-white: #ffffff;
        ...
        /* 
        =========================================================
        --- HEADER "WOW" FINAL UNTUK DASHBOARD ---
        =========================================================
        */
        .main-header {
        ...
        .main-header .logo-icon { color: var(--brand-primary-dark); }
        .main-header .logo-text { font-family: 'Playfair Display', serif; font-size: 1.75rem; font-weight: 700; color: var(--brand-text); }
        .main-header .nav-actions { display: flex; align-items: center; gap: 1.5rem; /* Jarak antar link diperbesar */ }
